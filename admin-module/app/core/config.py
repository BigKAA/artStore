...
class JWTSettings(BaseSettings):
    ...
    private_key_path: str = Field(default="/app/keys/private_key.pem", alias="JWT_PRIVATE_KEY_PATH")
    public_key_path: str = Field(default="/app/keys/public_key.pem", alias="JWT_PUBLIC_KEY_PATH")
    ...
    def load_private_key_from_provider(cls, v: str) -> str:
        ...
        return v if v else "/app/keys/private_key.pem"
    ...
    def load_public_key_from_provider(cls, v: str) -> str:
        ...
        # Fallback на provided value (env path или default)
        return v if v else "/app/keys/public_key.pem"
